...
import me.conclure.cityrp.gui.framework.OpenableInventoryHolder;
...
public class PositionRegistryGuiManager {
    ...
    public PositionRegistryGuiManager() {
        int pages = Registries.POSITIONS.size() / ITEMS_PER_PAGE;
        boolean needsExtraPage = Registries.POSITIONS.size() % ITEMS_PER_PAGE > 0;
