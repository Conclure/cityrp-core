...
public class ItemOverrideListener implements Listener {
    ...
    private me.conclure.cityrp.paper.item.Item processItem(
            ItemStack itemStack,
        ...
        String bypassKey = me.conclure.cityrp.paper.item.Item.BYPASS_KEY;
        if (tag.hasKey(bypassKey)) {
            return null;
        }

        String uniqueKey = me.conclure.cityrp.paper.item.Item.UNIQUE_KEY;
        ...
        me.conclure.cityrp.paper.item.Item item = Registries.ITEMS.getByKey(key);
    ...
    private void handleItemDrop(Item itemDrop) {
        ...
        me.conclure.cityrp.paper.item.Item item = this.processItem(itemStack, itemDrop::setItemStack, itemDrop::remove);
    ...
    public void onCreative(InventoryCreativeEvent event) {
        ...
        me.conclure.cityrp.paper.item.Item item = this.processItem(itemStack, event::setCursor, () -> event.setCursor(ItemStacks.AIR_STACK));
    ...
    public void onMove(InventoryMoveItemEvent event) {
        ...
        me.conclure.cityrp.paper.item.Item item = this.processItem(itemStack, event::setItem, () -> event.setItem(ItemStacks.AIR_STACK));
