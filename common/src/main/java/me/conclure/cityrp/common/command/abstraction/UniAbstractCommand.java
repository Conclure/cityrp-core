...
import me.conclure.cityrp.common.command.argument.Argument;
import me.conclure.cityrp.common.command.argument.ArgumentParseResult;
...
public abstract class UniAbstractCommand<S extends Sender, A0>
    ...
    protected UniAbstractCommand(CommandInfo<S> commandInfo, Argument<A0, S> argument0) {
        super(commandInfo);
